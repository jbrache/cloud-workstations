...
#   # "The parent of this AccessPolicy in the Cloud Resource Hierarchy. As of now, only organization are accepted as parent."
...
resource "google_access_context_manager_access_policy" "access-policy" {
  ...
  title  = "Cloud Workstations Scoped Access Policy"
  scopes = ["projects/${module.project.project_number}"]
}
...
resource "google_access_context_manager_access_policy_iam_binding" "binding" {
  ...
  members = var.access_policy_admin_email
}
...
resource "null_resource" "wait_for_members" {
  ...
  depends_on = [google_access_context_manager_access_policy_iam_binding.binding]
}
