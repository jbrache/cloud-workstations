...
# this is a simplified version of /etc/profile.d/disable_gcloud_gce_check.sh
#
# see also /etc/workstations-startup.d/015_config_gcloud_metadata_creds_check.sh
