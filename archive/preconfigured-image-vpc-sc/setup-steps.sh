...
export WORKSTATION_CLUSTER="code-oss-cluster"
export WORKSTATION_CONFIG="code-oss-config"
...
export CONTAINER_IMAGE="us-central1-docker.pkg.dev/cloud-workstations-images/predefined/code-oss:latest"
